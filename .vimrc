...
"coc.nvim插件的自动安装
let g:coc_global_extensions = ['coc-json', 'coc-html', 'coc-css', 'coc-sh', 'coc-cmake', 'coc-clangd', 'coc-pyright']
...
let g:ycm_complete_in_strings = 1   "在字符串中使用补全
